...
CREATE TABLE petss (
                      ...
                      owner_id INTEGER REFERENCES ownerss(owner_id),
                      name VARCHAR(100),
...
INSERT INTO ownerss (name, email, phone)
VALUES
    ('Scott Turner', 'sturner@cpd.gov', '911'),
    ('Michael Dooley', 'dooley@cpd.gov', '911'),
    ('Sabrina Spellman', 'iamnotawitch@hotmail.com', '555-
0117'),
    ('Jon Snow', 'jonsnow@nightwatch.org', '555-1439'),
    ('Joe Camber', 'castlerockcarservice@hotmail.com',
     '555-7125'),
    ('Ellie Creed', 'misscreed@yahoo.com', '555-2559'),
    ('Emily Elizabeth', 'ihateflorence@hotmail.com', '555-
2559'),
    ('Daenerys Targaryen', 'dracomama@veryhotmail.com',
     '555-0309'),
    ('Vic', 'itslegalinpostap@somemail.com', '555-1335'),
    ('Yorick Brown', 'lastman@hotmail.com', '555-0001');
INSERT INTO petss (owner_id, name, animal_type, breed, age,
                  vaccinations)
VALUES
    ...
    (5, 'Cujo', 'dog', 'saint bernard', 8, 'all, except
rabies'),
    (6, 'Church (Winston Churchill)', 'cat', 'domestic
cat', 10, 'all'),
